...
<form name="form-data" id="form-data" method="POST" class="adminpro-form" data-route="{{ route('dataProfe') }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="login-title">
                        <h1 class="text-center">REGISTRAR PROFESOR</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4">
                        ...
                        <div class="login-input-area">
                            <input type="text" name="apellido" id="apellido" require="true"/>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4">
                        <span>Profesión</span>
                        <div class="login-input-area">
                            <input type="text" name="profesion" id="profesion" require="true"/>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4">
                        ...
                        <div class="input-mark-inner mg-b-22">
                            <input type="text" name="telefono" id="telefono" class="form-control" data-mask="(999) 999-9999" placeholder="">
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4">
                        ...
                        <div class="input-mark-inner">
                            <input type="text" name="edad" id="edad" class="form-control" data-mask="99" placeholder="">
                        </div>
                    </div>
...
$("#btnEnviar").click(function (e) {
    ...
    var form_data = $(this);
        ...
        success:function(response){
           // $('#form-data')[0].reset(); //Limpiando el Form
            $("#contenMsjs").show();
